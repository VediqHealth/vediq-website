    ...
    <main>
      <section className="section shell">
        <div className="intro">
          ...
          <p>Request a focused walkthrough of Vediq Companion and Vediq Command Center. We&apos;ll discuss your organization, current EHR workflow and value-based care priorities.</p>
        </div>
